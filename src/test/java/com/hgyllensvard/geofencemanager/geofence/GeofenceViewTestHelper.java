...
import com.hgyllensvard.geofencemanager.geofence.map.GeofenceViewUpdate;
...
public class GeofenceViewTestHelper {
    ...
    public static final GeofenceView GEOFENCE_VIEW_ONE = new GeofenceView(GeofenceTestHelper.TEST_GEOFENCE_ONE_WITH_ID, FILL_COLOR, STROKE_COLOR);
    public static final GeofenceView GEOFENCE_VIEW_TWO = new GeofenceView(GeofenceTestHelper.TEST_GEOFENCE_TWO_WITH_ID, FILL_COLOR, STROKE_COLOR);
